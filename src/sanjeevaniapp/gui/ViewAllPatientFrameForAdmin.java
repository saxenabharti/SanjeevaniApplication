 ...
 * @author hp
 */
public class ViewAllPatientFrameForAdmin extends javax.swing.JFrame {

    private DefaultTableModel model;
    public ViewAllPatientFrameForAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 810, 220));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAllPatientFrameForAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAllPatientFrameForAdmin().setVisible(true);
            }
        });
    }
